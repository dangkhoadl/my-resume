...
\begin{document}
    ...
    \section{Work Experience (selected)}
        ...
        \vspace{-5mm}
        $\bullet$ {Train Automatic Recognition System (ASR) using Kaldi (classical ASR Engine) and Espnet (state-of-the-art end-to-end ASR engine) for Bangali and Tamil Language.} \\
        ...
        \emph{Technologies}: \textbf{Kaldi, Espnet, Pandas, Numpy, Pytorch}
