...
\begin{document}
    ...
    \section{Work Experience (selected)}
        ...
        \vspace{-5mm}
        $\bullet$ {Prepare data and train model for Automatic Speech Recognition System, mostly text language models} \\
        $\bullet$ {Optimize team business operational cost} \\
        \emph{Languages/Technologies}: \textbf{Python, Bash}
